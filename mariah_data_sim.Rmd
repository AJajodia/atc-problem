...
airports <- tibble(airport = c("A", "B", NA, "C", "D", "E", NA, "F", "G"), sector = c(1:sector_count^2), lat = lats, long = longs, holding_time, turnaround_time, sector_capacity, ground_cost, air_cost, min_time, time_buffer, depart_capacity, arrival_capacity, sector_count, airspeed)
```
...
```{r}
write.csv(airports, "mariah_airports.csv")
