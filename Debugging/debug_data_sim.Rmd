...
airport_sectors <- tibble(airport = c("A", "B", "C", "D"), airport_long = longs, airport_lat = lats, sector = c(1:sector_count^2), xmin = xmins, xmax = xmaxs, ymin = ymins, ymax = ymaxs, sector_capacity, depart_capacity, arrival_capacity, sector_count)
```
...
for (i in 1:flight_count) {
  ...
  A <- airports_pair[1,]
  B <- airports_pair[2,]
  departure_times[i] <- sample(1:10, 1)
